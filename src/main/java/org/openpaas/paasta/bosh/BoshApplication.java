...
//            }
            try {
//                if (boshDirector.updateInstanceState("webide-broker-service", "webide-broker", "3eca4880-e0b2-4240-b7d0-4120469df841", BoshDirector.INSTANCE_STATE_DETACHED)) {
...
//                }
                ...
                if (boshDirector.deploy("webide-broker-service", "webide-broker")) {
                    System.out.println("Deploy 성공");
                } else {
                    System.out.println("Deploy 실패");
                }
